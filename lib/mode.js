...
exports.implicitBranches = [exports.defaultBranch, 'stable'];
...
Module.prototype.__defineGetter__('activeId', function(){
  ...
  else if (this.repoBranch &&
    !(this.repoBranch in exports.implicitBranches) &&
    (!this.info.repoBranch || this.repoBranch !== this.info.repoBranch)
    )
  {
    p += '@'+this.repoBranch;
  }
...
Module.prototype.toString = function(detailed){
  return this.id+'@'+this.repoBranch;
}
...
Module.prototype._fetchGit = function(options, callback) {
  ...
  fs.stat(this.config.installDir, function(err, stats) {
    if (!err && stats && stats.isDirectory()) {
      ...
      else if (self.repoBranch &&
        !(self.repoBranch in exports.implicitBranches))
      {
